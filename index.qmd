...
<div class="cards-grid-outer">
  <div class="cards-grid">
    ...
    <div class="card card-pottery">
      <div class="card-inner">
        ...
        <div class="card-text">
          ...
          <a href="https://lasrubieraspottery.com" class="card-link-text">Visit the shop →</a>
        </div>
      </div>
    </div>
    ...
    <div class="card card-aikido">
      <div class="card-inner">
        <div class="card-logo-panel">
          <img src="images/aikido-logo.png" class="card-logo-img" alt="Aikido of Wisconsin">
        </div>
        <div class="card-vdivider"></div>
        <div class="card-text">
          <h3 class="card-title-text">Aikido</h3>
          <p class="card-desc-text">Aikido of Wisconsin, based in Janesville. A martial art centered on harmony, movement, and practice.</p>
